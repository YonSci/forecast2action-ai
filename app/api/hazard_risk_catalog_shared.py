...
LAYER_DEFINITIONS = [
    ...
    # Exposure sectors -- all normalized 0-1, all static (one file each,
    # applies to every period, like population_normalized already did).
    {"value": "population_normalized", "category": "exposure", "hazard_type": None, "label": "Population", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
    {"value": "cropland_rainfed_normalized", "category": "exposure", "hazard_type": None, "label": "Cropland (Rainfed)", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
    {"value": "cropland_irrigated_normalized", "category": "exposure", "hazard_type": None, "label": "Cropland (Irrigated)", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
    {"value": "cropland_total_normalized", "category": "exposure", "hazard_type": None, "label": "Cropland (Total)", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
    {"value": "livestock_cattle_normalized", "category": "exposure", "hazard_type": None, "label": "Livestock (Cattle)", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
    {"value": "built_up_normalized", "category": "exposure", "hazard_type": None, "label": "Built-up Areas", "units": "normalized", "vmin": 0.0, "vmax": 1.0, "cmap": "YlOrRd", "low_label": "Low exposure", "high_label": "High exposure", "is_categorical": False},
